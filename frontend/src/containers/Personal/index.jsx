...
const Personal = () => {
    return (
        <div className='container'>
            ...
            меры по обеспечению безопасности персональных данных, предпринимаемые Антоновым Ильей Александровичем (далее
            – Оператор).<br/>
            ...
            ко всей информации, которую Оператор может получить о посетителях веб-сайта http://tournirken.ru.<br/>
            <br/>
            ...
            обеспечивающих их доступность в сети интернет по сетевому адресу http://tournirken.ru;<br/>
            ...
            определяемому Пользователю веб-сайта http://tournirken.ru;<br/>
            ...
            3.2. Также на сайте происходит сбор и обработка обезличенных данных о посетителях (в т.ч. файлов «cookie») с
            ...
            информации и/или материалам, содержащимся на веб-сайте; предоставления возможности Пользователям связаться с
            Пользователем.<br/>
            ...
            сообщений, направив Оператору письмо на адрес электронной почты ilan23f@gmail.com с пометкой «Отказ от
            ...
            Пользователем самостоятельно через специальные формы, расположенные на сайте http://tournirken.ru. Заполняя
            ...
            ilan23f@gmail.com с пометкой «Актуализация персональных данных».<br/>
            ...
            на электронный адрес Оператора ilan23f@gmail.com с пометкой «Отзыв согласия на обработку персональных
            данных».<br/>
            <br/>
            ...
            персональных данных, обратившись к Оператору с помощью электронной почты ilan23f@gmail.com.<br/>
            ...
            http://tournirken.ru/personal. <br/>
            <br/>
        </div>
    )
};
